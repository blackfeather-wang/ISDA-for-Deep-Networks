...
```
CUDA_VISIBLE_DEVICES=0,1 python imagenet_DDP.py PATH_TO_DATASET --model MODEL_NAME --pre-train PATH_TO_PRE_TRAINED_MODELS -e --batch-size 512 --lr 0.2 --epochs 300 --lambda_0 0 --workers 32 --dist-url 'tcp://127.0.0.1:12345' --dist-backend 'nccl' --multiprocessing-distributed --world-size 1 --rank 0
```

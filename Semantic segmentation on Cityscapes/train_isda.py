...
def main():
    ...
    with Engine(custom_parser=parser) as engine:
        ...
        isda_augmentor_1 = ISDALoss(512, args.num_classes, device)
        isda_augmentor_2 = ISDALoss(512, args.num_classes, device)
        ...
        while run:
            ...
            for idx in pbar:
                ...
                optimizer.zero_grad()
                lr = adjust_learning_rate(optimizer, args.learning_rate, global_iteration - 1, args.num_steps,
                                          args.power)
